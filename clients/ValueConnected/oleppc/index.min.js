...
var myApp = angular.module('myApp', [])
    .controller('myCtrl', ['$scope', function ($scope) {
        ...
        vm.model = {
            ...
            I14: 50,
            I50: 50,
            K6: 74253, L6: 76708, M6: 18984,
            K7: 73920.79, L7: 0.00, M7: 0.00,
            K8: 0.00, L8: 76590.16, M8: 793.50,
            ...
            get B78() { return 1 - (this.B81 / 100) - (this.B82 / 100) - (this.B83 / 100) },
            get B80() { return this.B78 - (this.B79 / 100) },
            get B84() { return (this.B83 / 100) * (51 / 100) },
            get B85() { return (this.B83 / 100) * (26 / 100) },
            get B86() { return (this.B83 / 100) * (23 / 100) },
            get B157() { return (this.B156 / 100) - (this.B158 / 100) },
            ...
            get G50() { return ((this.E50 * this.E51)) },
            ...
            get B97() { return this.B4 * (this.B80) * vm.get_nicca_row(1).i }, get C97() { return this.B4 * (this.B80) * vm.get_nicca_row(1).j },
            get B98() { return this.B4 * (this.B80) * vm.get_nicca_row(2).i }, get C98() { return this.B4 * (this.B80) * vm.get_nicca_row(2).j },
            get B99() { return this.B4 * (this.B80) * vm.get_nicca_row(3).i }, get C99() { return this.B4 * (this.B80) * vm.get_nicca_row(3).j },
            get B100() { return this.B4 * (this.B80) * vm.get_nicca_row(4).i }, get C100() { return this.B4 * (this.B80) * vm.get_nicca_row(4).j },
            get B101() { return this.B4 * (this.B80) * vm.get_nicca_row(5).i }, get C101() { return this.B4 * (this.B80) * vm.get_nicca_row(5).j },
            get B102() { return this.B4 * (this.B80) * vm.get_nicca_row(6).i }, get C102() { return this.B4 * (this.B80) * vm.get_nicca_row(6).j },
            ...
            get B129() { return this.B4 * this.B84 * vm.get_nicca_row(1).o }, get C129() { return this.B4 * this.B84 * vm.get_nicca_row(1).p },
            get B130() { return this.B4 * this.B84 * vm.get_nicca_row(2).o }, get C130() { return this.B4 * this.B84 * vm.get_nicca_row(2).p },
            get B131() { return this.B4 * this.B84 * vm.get_nicca_row(3).o }, get C131() { return this.B4 * this.B84 * vm.get_nicca_row(3).p },
            get B132() { return this.B4 * this.B84 * vm.get_nicca_row(4).o }, get C132() { return this.B4 * this.B84 * vm.get_nicca_row(4).p },
            get B133() { return this.B4 * this.B84 * vm.get_nicca_row(5).o }, get C133() { return this.B4 * this.B84 * vm.get_nicca_row(5).p },
            get B134() { return this.B4 * this.B84 * vm.get_nicca_row(6).o }, get C134() { return this.B4 * this.B84 * vm.get_nicca_row(6).p },
            ...
            get B181() { return this.B4 * this.B157 * vm.get_nicca_row(1).e }, get C181() { return this.B4 * this.B157 * vm.get_nicca_row(1).f },
            get B182() { return this.B4 * this.B157 * vm.get_nicca_row(2).e }, get C182() { return this.B4 * this.B157 * vm.get_nicca_row(2).f },
            get B183() { return this.B4 * this.B157 * vm.get_nicca_row(3).e }, get C183() { return this.B4 * this.B157 * vm.get_nicca_row(3).f },
            get B184() { return this.B4 * this.B157 * vm.get_nicca_row(4).e }, get C184() { return this.B4 * this.B157 * vm.get_nicca_row(4).f },
            get B185() { return this.B4 * this.B157 * vm.get_nicca_row(5).e }, get C185() { return this.B4 * this.B157 * vm.get_nicca_row(5).f },
            get B186() { return this.B4 * this.B157 * vm.get_nicca_row(6).e }, get C186() { return this.B4 * this.B157 * vm.get_nicca_row(6).f },
            ...
            get N7() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(1).k },
            get Q7() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(2).k },
            get T7() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(3).k },
            get W7() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(4).k },
            get Z7() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(5).k },

            get O8() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(1).aa },
            get P8() { return (this.B21 = this.G20 ? 1 + this.B19 : 1) * vm.get_exames_row(1).t },
            get R8() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(2).aa },
            get S8() { return (this.B21 = this.G20 ? 1 + this.B19 : 1) * vm.get_exames_row(2).t },
            get U8() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(3).aa },
            get V8() { return (this.B21 = this.G20 ? 1 + this.B19 : 1) * vm.get_exames_row(3).t },
            get X8() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(4).aa },
            get Y8() { return (this.B21 = this.G20 ? 1 + this.B19 : 1) * vm.get_exames_row(4).t },
            get AA8() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(5).aa },
            get AB8() { return (this.B21 = this.G20 ? 1 + this.B19 : 1) * vm.get_exames_row(5).t },

            get P9() { return (this.B21 = this.G20 ? 1 + this.B20 : 1) * vm.get_exames_row(1).r },
            get S9() { return (this.B21 = this.G20 ? 1 + this.B20 : 1) * vm.get_exames_row(2).r },
            get V9() { return (this.B21 = this.G20 ? 1 + this.B20 : 1) * vm.get_exames_row(3).r },
            get Y9() { return (this.B21 = this.G20 ? 1 + this.B20 : 1) * vm.get_exames_row(4).r },
            get AB9() { return (this.B21 = this.G20 ? 1 + this.B20 : 1) * vm.get_exames_row(5).r },

            get N10() { return vm.get_exames_row(1).l },
            get O10() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(1).ab },
            get P10() { return vm.get_exames_row(1).s },
            get Q10() { return vm.get_exames_row(2).l },
            get R10() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(2).ab },
            get S10() { return vm.get_exames_row(2).s },
            get T10() { return vm.get_exames_row(3).l },
            get U10() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(3).ab },
            get V10() { return vm.get_exames_row(3).s },
            get W10() { return vm.get_exames_row(4).l },
            get X10() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(4).ab },
            get Y10() { return vm.get_exames_row(4).s },
            get Z10() { return vm.get_exames_row(5).l },
            get AA10() { return (this.B21 = this.G20 ? 1 + this.B18 : 1) * vm.get_exames_row(5).ab },
            ...
            get K7() { return Math.round(this.N7 + this.Q7 + this.T7 + this.W7 + this.Z7) },
            ...
            get M11() { return Math.round(this.B4 * (this.B80)) },
            ...
            get Q26() { return (this.Q12 * this.B13) }, get Q27() { return (this.Q13 * this.B14) },
            get R26() { return (this.R12 * this.B13) }, get R27() { return (this.R13 * this.B14) },
            get S26() { return (this.S12 * this.B13) }, get S27() { return (this.S13 * this.B14) },
            get T26() { return (this.T12 * this.B13) }, get T27() { return (this.T13 * this.B14) },
            get U26() { return (this.U12 * this.B13) }, get U27() { return (this.U13 * this.B14) },
            get V26() { return (this.V12 * this.B13) }, get V27() { return (this.V13 * this.B14) },
            get W26() { return (this.W12 * this.B13) }, get W27() { return (this.W13 * this.B14) },
            get X26() { return (this.X12 * this.B13) }, get X27() { return (this.X13 * this.B14) },
            get Y26() { return (this.Y12 * this.B13) }, get Y27() { return (this.Y13 * this.B14) },
            get Z26() { return (this.Z12 * this.B13) }, get Z27() { return (this.Z13 * this.B14) },
            get AA26() { return (this.AA12 * this.B13) }, get AA27() { return (this.AA13 * this.B14) },
            get AB26() { return (this.AB12 * this.B13) }, get AB27() { return (this.AB13 * this.B14) },
        ...
        vm.add_nic_ca = (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, s) => {
            const nicca = {
                a: a, b: b, c: c, d: d, e: e, f: f, g: g, h: h, i: i, j: j, k: k, l: l, m: m, n: n, o: o, p: p, q: q, s: s,
                r: q / (m / n),
                t: s / (m / n)
            }
        ...
        vm.add_exames = (a, b, c) => {
            ...
            if (a === 1) {
                ...
                n_val = (vm.model.E78 >= a ? 0 : Math.floor((a - 0.001) / vm.model.E78) * vm.model.B78 * d_val);
                ...
                w_val = (vm.model.E162 >= a ? 0 : Math.floor(c / vm.model.E162) * (vm.model.B162 / 100) * d_val);
                ...
                h_val = (vm.model.E32 < a ? (vm.model.E34 + vm.model.E32 >= a ? 0 : Math.floor((a - vm.model.E32 - 0.000001) / vm.model.E34, 0) * vm.model.B34 * d_val) : 0);
                i_val = (vm.model.E32 >= a ? 0 : (vm.model.E32 < c ? 0 : 1)) * d_val * vm.model.B35;
                n_val = (vm.model.E78 >= a ? 0 : Math.floor(c / vm.model.E78) * vm.model.B78 * d_val - vm.get_exames_sum('n', 2));
                p_val = (vm.model.E82 >= a ? 0 : (Math.floor(c / vm.model.E82) * (vm.model.B82 / 100) * d_val) - vm.get_exames_sum('p', 2));
                //=IF(Análise!$E$82>=$C8,0,ROUNDDOWN($C7/Análise!$E$82,0)*Análise!$B$82*$D7-SUM(P$6:P6))
                ...
                datasets: [
                    {
                        ...
                        data: [1423386, 2741426, 4059466, 5377506, 6695546],
                        borderWidth: 2,
                        borderColor: "#023970",
                    ...
                    },
                    {
                        ...
                        data: [1942652, 3759020, 5601761, 7470875, 9366363],
                        borderWidth: 2,
                        borderColor: "#FDB713",
                    ...
                    {
                        label: 'OnClarity',
                        data: [5436024, 5742099, 6048174, 6354349, 6660024],
                        borderWidth: 2,
                        borderColor: "#D15421",
        ...
        vm.$onInit = function () {
            ...
            vm.populateNiCa();
            console.log(vm.nic_ca);
            vm.populateExames();
            console.table(vm.exames);
